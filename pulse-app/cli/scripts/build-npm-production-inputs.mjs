...
export async function buildNpmProductionInputs({
  ...
  if (catalog.value.production_ready !== true || catalog.value.release_epoch !== 9 ||
      ...
      artifactSet.value.payload?.release?.version !== '0.8.1' || documents.manifest !== artifactSet.bytes ||
      documents.packageJSON?.name !== '@zbs-gg/pulse' || documents.packageJSON?.version !== '0.8.1' ||
