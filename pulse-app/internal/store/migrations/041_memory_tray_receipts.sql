...
-- applicable only to Personal and Desk stores; the migration runner records
-- it as skipped for Local Preview and Commons.
...
CREATE TABLE turn_ledgers (
    ...
    destination_class    TEXT NOT NULL CHECK(destination_class IN ('personal','desk')),
...
UPDATE store_identity
   SET min_reader_version = 41,
       min_writer_version = 41
 WHERE singleton = 1;
