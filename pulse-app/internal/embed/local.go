...
// protocol; the legacy constructor remains for developer and Team runtimes.
package embed
...
// NewLocal preserves the legacy helper invocation used by development and
// Team deployments. bge-m3 output is still held to the 1024d vector contract.
