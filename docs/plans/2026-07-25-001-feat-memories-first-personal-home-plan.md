...
- Historical product decisions, used only where not superseded here: `docs/plans/2026-07-15-001-feat-personal-pulse-one-command-onboarding-plan.md` and `docs/plans/2026-07-16-001-feat-personal-git-team-memory-reset-plan.md`.
