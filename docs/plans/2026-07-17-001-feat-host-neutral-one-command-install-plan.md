...
- **Authority:** This plan narrows the earlier Personal install work; the user's current host-parity direction overrides the older Codex-only onboarding boundary.
...
- Linux, Windows, Intel macOS, remote synchronization, and new source adapters.
...
- The earlier multiharness work supplies the active-harness extraction direction.
