...
function receipt(overrides: Record<string, unknown> = {}) {
  return {
    ...
    candidate_id: 'candidate_01', candidate_version: 1, status: 'pending', destination: 'desk',
    destination_store_id: 'store_desk_01',
    safe_provenance: {
...
function result(item = receipt(), overrides: Record<string, unknown> = {}) {
  return {
    ...
    finalize_receipt: {
      ...
      status: 'candidates', destination: 'desk', destination_store_id: 'store_desk_01',
      safe_provenance: {
        host: 'codex', session_id: 'session_01', turn_id: 'turn_01',
        source_event_key: 'codex:session_01:turn_01:stop',
      },
